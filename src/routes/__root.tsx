...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Découvrez des projets africains structurés et à fort potentiel, et accédez à des opportunités d’investissement sélectionnées." },
      { name: "author", content: "MiPROJET" },
      { property: "og:title", content: "MiPROJET Invest — Financez des projets africains certifiés" },
      { property: "og:description", content: "Découvrez des projets africains structurés et à fort potentiel, et accédez à des opportunités d’investissement sélectionnées." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "MiPROJET Invest — Financez des projets africains certifiés" },
      { name: "twitter:description", content: "Découvrez des projets africains structurés et à fort potentiel, et accédez à des opportunités d’investissement sélectionnées." },
